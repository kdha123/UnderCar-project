...
<a href="/event/list.do"><span ><button style="width: 400px;height: 300px" type="button" class="btn btn-warning">
<strong style="font-size: 40px; margin: 20px">이벤트</strong><div style="font-size: 20px; margin: 20px;"></div>
<i class="fa fa-car fa-3x" ></i>
</button></span></a>
 </div>
 
 <div id="latest">
			<h3 align="center">최근에 등록된 자동차!</h3>
		<!-- 이미지 겔러리 리스트 작성 -->
