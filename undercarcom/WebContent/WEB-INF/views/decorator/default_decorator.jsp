		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="/main.do">UnderCar</a>
				</div>
				<!-- 모듈 메뉴 -->
...
<!-- 						<li><a href="/image/list.do">이미지</a></li> -->
						<li><a href="/sell/list.do">판매</a></li>
						<li><a href="/qna/list.do">1:1질문</a></li>
						<li><a href="/faq/list.do">자주하는질문</a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						<!-- 로그인을 안한 경우의 메뉴 -->
						<c:if test="${empty login }">
							<li><a href="/member/select.do"><span
						...
						<c:if test="${!empty login }">
							...
							<li><a href="/member/info.do"> 내 정보 보기</a></li>
